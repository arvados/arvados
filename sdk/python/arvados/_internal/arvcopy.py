...
def api_for_instance(instance_name, num_retries):
    ...
    googleapi_level = googleapi_logger.level
    ...
    try:
        ...
        raise Exception('Unable to find usable ARVADOS_API_HOST and ARVADOS_API_TOKEN')
    finally:
        # However we exited out, put googleapi_logger back to the
        # previous level
        googleapi_logger.setLevel(googleapi_level)
