...
Use the following command to connect to the "shell" VM instance as "you".  Replace <code>you@shell</code> at the end of the following command with your login and hostname:
