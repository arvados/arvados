...
bc. $ ssh-keygen -t rsa -C "you@example.com"
...
bc. $ ssh -o "ProxyCommand ssh -a -x -p2222 turnout@switchyard.{{ site.arvados_api_host }} shell" -A -x you@shell 
