...
This will reload the page, and should now show a row of information.  Click on the cell _none_ under the *public_key* column heading.  This should open up an editing popup as shown in this screenshot:
...
<pre>plink -P 2222 turnout@switchyard.qr1hi.arvadosapi.com %host</pre>  Make sure there is no newline at the end of the text entry.
