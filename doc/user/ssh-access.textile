...
title: Accessing an Arvados VM
navorder: 2
---

h1. Accessing an Arvados Virtual Machine
...
This indicates that you have not yet provided Arvados with your public @ssh@ key.  Click on "SSH keys" or use the menu item _Access %(rarr)&rarr;% Keys_ to add an authorized ssh key to your account.
...
notextile. <pre><code>$ <span class="userinput">ssh -o "ProxyCommand ssh -a -x -p2222 turnout@switchyard.{{ site.arvados_api_host }} shell" -A -x you@shell</span></code></pre>
