...
class ContainerRequestTest < ActiveSupport::TestCase
  ...
  [
    ...
    {"runtime_constraints" => {"vcpus" => "1", "ram" => 1234567}},
    {"runtime_constraints" => {"vcpus" => 1, "ram" => 1234567, "badkey" => 2}},
    {"runtime_constraints" => {"vcpus" => 1, "ram" => 1234567, "gpu" => {"badkey" => "badvalue"}}},
    {"runtime_constraints" => {"vcpus" => 1, "ram" => 1234567, "gpu" => []}},
    {"runtime_constraints" => {"vcpus" => 1, "ram" => 1234567, "gpu" => "bad"}},
    {"runtime_constraints" => ["bad"]},
    {"runtime_constraints" => "bad"},
    {"scheduling_parameters" => {"badkey" => "value"}},
    {"scheduling_parameters" => {"badkey" => ["value"]}},
    {"mounts" => {"/foo" => "BAR"}},
    {"mounts" => {"/foo" => {}}},
    {"mounts" => {"foo" => {"kind" => "tmp"}}},
