...
use when it executes the command inside this container.",
    ...
    "description" => "A longer description of this %s assigned by a user.  May contain HTML formatting. Allowed HTML tags are: a, b, blockquote, br, code, del, dd, dl, dt, em, h1, h2, h3, h4, h5, h6, hr, i, img, kbd, li, ol, p, pre, s, del, section, span, strong, sub, sup, and ul.",
    "environment" =>
