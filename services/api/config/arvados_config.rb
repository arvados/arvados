...
database_url = "postgresql://#{CGI.escape $arvados_config["PostgreSQL"]["Connection"]["user"]}:"+
                      ...
                      "template=#{CGI.escape $arvados_config["PostgreSQL"]["Connection"]["template"]}&"+
                      "encoding=#{CGI.escape $arvados_config["PostgreSQL"]["Connection"]["client_encoding"]}&"+
                      "collation=#{CGI.escape $arvados_config["PostgreSQL"]["Connection"]["collation"]}&"+
