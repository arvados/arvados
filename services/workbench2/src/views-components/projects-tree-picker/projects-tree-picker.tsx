            ...
            render() {
                ...
                return <>
                    <div className={this.props.classes.searchFlex}>
                        <span data-cy="picker-dialog-project-search"><SearchInput label="Project search" onSearch={onProjectSearch} debounce={500} width="18rem"  /></span>
                {this.props.includeCollections &&
                    <span data-cy="picker-dialog-collection-search" ><SearchInput label="Collection search" onSearch={onCollectionFilter} debounce={500} width="18rem" /></span>}
                </div>
