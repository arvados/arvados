...
namespace :deploy do
  ...
  task :copy_files, :roles => :app,  :except => { :no_release => true } do
    ...
    run "cp /home/passenger/vcffarm/database.yml #{release_path}/config/database.yml"
    run "cp /home/passenger/vcffarm/secret_token.rb #{release_path}/config/initializers/secret_token.rb"
    run "cp /home/passenger/vcffarm/production.rb #{release_path}/config/environments/production.rb"
