...
func (s *DispatcherSuite) TestManagementAPI_Containers(c *check.C) {
 ...
 2 zzzzz-dz642-000000000000002 (Locked) "Waiting in container queue at position 1.  Cluster is at capacity for all the eligible instance types (type4, type6) and cannot start a new instance right now."
 3 zzzzz-dz642-000000000000003 (Locked) "Waiting in container queue at position 2.  Cluster is at capacity for all the eligible instance types (type4, type6) and cannot start a new instance right now."
 4 zzzzz-dz642-000000000000004 (Queued) "Waiting in container queue at position 3.  Cluster is at capacity and cannot start any new instances right now."
 5 zzzzz-dz642-000000000000005 (Queued) "Waiting in container queue at position 4.  Cluster is at capacity and cannot start any new instances right now."
 6 zzzzz-dz642-000000000000006 (Queued) "Waiting in container queue at position 5.  Cluster is at capacity and cannot start any new instances right now."
 7 zzzzz-dz642-000000000000007 (Queued) "Waiting in container queue at position 6.  Cluster is at capacity and cannot start any new instances right now."
 8 zzzzz-dz642-000000000000008 (Queued) "Waiting in container queue at position 7.  Cluster is at capacity and cannot start any new instances right now."
 9 zzzzz-dz642-000000000000009 (Queued) "Waiting in container queue at position 8.  Cluster is at capacity and cannot start any new instances right now."
 10 zzzzz-dz642-000000000000010 (Queued) "Waiting in container queue at position 9.  Cluster is at capacity and cannot start any new instances right now."
 11 zzzzz-dz642-000000000000011 (Queued) "Waiting in container queue at position 10.  Cluster is at capacity and cannot start any new instances right now."
 12 zzzzz-dz642-000000000000012 (Queued) "Waiting in container queue at position 11.  Cluster is at capacity and cannot start any new instances right now."
 13 zzzzz-dz642-000000000000013 (Queued) "Waiting in container queue at position 12.  Cluster is at capacity and cannot start any new instances right now."
 14 zzzzz-dz642-000000000000014 (Queued) "Waiting in container queue at position 13.  Cluster is at capacity and cannot start any new instances right now."
 15 zzzzz-dz642-000000000000015 (Queued) "Waiting in container queue at position 14.  Cluster is at capacity and cannot start any new instances right now."
 16 zzzzz-dz642-000000000000016 (Queued) "Waiting in container queue at position 15.  Cluster is at capacity and cannot start any new instances right now."
 17 zzzzz-dz642-000000000000017 (Queued) "Waiting in container queue at position 16.  Cluster is at capacity and cannot start any new instances right now."
 18 zzzzz-dz642-000000000000018 (Queued) "Waiting in container queue at position 17.  Cluster is at capacity and cannot start any new instances right now."
 19 zzzzz-dz642-000000000000019 (Queued) "Waiting in container queue at position 18.  Cluster is at capacity and cannot start any new instances right now."
`
